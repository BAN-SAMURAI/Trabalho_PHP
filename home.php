...
<head>
    ...
    <style>
        ...
        /* Cores KPI */
        .bg-enf { background-color: #28a745; }
        .bg-inf { background-color: #6f42c1; }
        .bg-ds { background-color: #dc3545; }
        .bg-adm { background-color: #0d1b2a; }
        ...
        .header-bar-horiz { background: linear-gradient(45deg, #cb2d3e, #ef473a); }
